...
from src.core.cliente.application.use_case.actions.update_cliente import UpdateCliente, UpdateClienteRequest
...
class TestUpdateClienteIntegration(TestCase):
    ...
    def test_update_cliente_nome(self):
        request = UpdateClienteRequest(id=self.cliente.id, nome="João Carlos")
    ...
    def test_update_cliente_not_found(self):
        request = UpdateClienteRequest(id=uuid.uuid4(), nome="Novo Nome")
